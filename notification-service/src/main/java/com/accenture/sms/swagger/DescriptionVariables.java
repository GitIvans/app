...
public class DescriptionVariables {
    ...
    public static final String NOTIFICATION_CONTROLLER = "Notification Controller";
    public static final String NOTIFICATION_MODEL = "Model representing notifications";
    ...
    public static final String USER_ID_MIN = "Id must be bigger than 0";
    public static final String USER_ID_MAX = "Id must be less than 9,223,372,036,854,775,808";
